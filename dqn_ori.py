...
MEM_SIZE = int(
    1e6
)  # this is either 250k or 1 million in the paper (size of replay memory)
...
scheduler = EpsilonScheduler(schedule=[(0, 1), (INIT_MEMORY_SIZE,
                                                1), (2e6, 0.1), (30e6, 0.01)])
...
for episode in range(EPISODES):
    ...
    print(
        f"[EPISODE {episode}] Loss: {avg_loss}, " +
        f"Total Reward: {total_reward}, Total Unclipped Reward: {unclipped_reward}, " +
        f"Frames: {frame}, Epsilon: {scheduler.epsilon()}, " +
